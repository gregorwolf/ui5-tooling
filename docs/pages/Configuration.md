...
For projects of type "application" a `Component-preload.js` is generated by default.

You can override the default behavior and define paths to one or multiple `Component.js`.
For every file a separate `Component-preload.js` will be generated. The paths can contain glob patterns.

```yaml
builder:
  componentPreload:
    paths:
        - "/resources/my/great/app/**/Component.js"
```

In addition, you can also define component namespaces:
...
These namespaces correspond to directory structures 
